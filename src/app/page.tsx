      ...
      <div className="max-w-6xl mx-auto px-6 py-20 space-y-24">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-lg text-gray-300 max-w-xl mx-auto">
            Your all-in-one budget tracking app. Manage expenses, control
            spending, and grow your savings.
          </p>
          <a
            href="/login"
...
function FeatureCard({
  ...
  return (
    <div className="bg-white/5 rounded-2xl p-6 backdrop-blur border border-white/10 text-center space-y-3">
